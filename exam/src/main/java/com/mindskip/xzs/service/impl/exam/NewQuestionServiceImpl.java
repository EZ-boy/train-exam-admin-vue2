...
@Service
public class NewQuestionServiceImpl extends BaseServiceImpl<Question> implements NewQuestionService {
    ...
    @Autowired
    public NewQuestionServiceImpl(NewQuestionMapper questionMapper, TextContentService textContentService, SubjectService subjectService) {
...
//                questionEditItemVM.setScore(ExamUtil.scoreToVM(o.getScore()));
                questionEditItemVM.setScore(String.valueOf(o.getScore()));
            }
    ...
    @Override
    public List<Question> getQuestionByType(Integer questionType, Integer rows, List<Integer> majorIds){
        return questionMapper.getQuestionByType(questionType, rows, majorIds);
    }
