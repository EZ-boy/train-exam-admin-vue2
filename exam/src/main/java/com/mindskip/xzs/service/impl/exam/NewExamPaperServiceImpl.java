...
@Service
public class NewExamPaperServiceImpl extends BaseServiceImpl<ExamPaper> implements NewExamPaperService {
    ...
    @Autowired
    public NewExamPaperServiceImpl(NewExamPaperMapper examPaperMapper, QuestionMapper questionMapper, TextContentService textContentService, QuestionService questionService, SubjectService subjectService) {
    ...
    @Override
    public PaperInfo getExamPaperByTid(Integer taskExamId){
        return examPaperMapper.getExamPaperByTid(taskExamId);
    }
