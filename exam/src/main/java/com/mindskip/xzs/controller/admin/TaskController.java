...
public class TaskController extends BaseApiController {
    ...
    public RestResponse<PageInfo<TaskPageResponseVM>> initList(@RequestBody TaskPageRequestVM model) {
        PageInfo<TaskExam> pageInfo = taskExamService.initQuery(model);
