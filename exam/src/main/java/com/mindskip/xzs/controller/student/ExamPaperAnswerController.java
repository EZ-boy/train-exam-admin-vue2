...
//            vm.setPaperScore(ExamUtil.scoreToVM(e.getPaperScore()));
            vm.setSystemScore(String.valueOf(e.getSystemScore()));
            vm.setUserScore(String.valueOf(e.getUserScore()));
            vm.setPaperScore(String.valueOf(e.getPaperScore()));
    ...
    public RestResponse answerSubmit(@RequestBody @Valid ExamPaperSubmitVM examPaperSubmitVM) {
        ...
        if (StringUtils.isNotBlank(examPaperSubmitVM.getIsPractice()) && StringUtils.equals("01", examPaperSubmitVM.getIsPractice())) {
            examPaperAnswer.setPaperType(7);
        }
