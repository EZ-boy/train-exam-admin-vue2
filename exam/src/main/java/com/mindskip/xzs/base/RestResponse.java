...
public class RestResponse<T> {
    ...
    public RestResponse(int code, String message, T response,long total) {
        this.code = code;
        this.message = message;
    ...
    public static <F> RestResponse<F> ok(F response,long total) {
        SystemCode systemCode = SystemCode.OK;
        return new RestResponse<>(systemCode.getCode(), systemCode.getMessage(), response ,total);
    }
