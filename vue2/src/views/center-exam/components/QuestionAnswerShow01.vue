    ...
    <div v-loading="qLoading" style="line-height: 1.8">
        <div v-if="qType == 1 || qType == 2 || qType == 3 || qType == 4 || qType == 5">
            ...
            <div v-else-if="qType == 2">
                ...
                <div class="q-content">
                    <el-checkbox-group v-model="answer.contentArray">
                        <el-checkbox disabled v-for="item in question.items" :label="item.prefix" :key="item.prefix">
                            <span class="question-prefix">{{ item.prefix }}.</span>
                            <span v-html="item.content" class="q-item-span-content"></span>
                        </el-checkbox>
                    </el-checkbox-group>
            ...
            <div v-else-if="qType == 3">
                ...
                <el-radio-group v-model="answer.content">
                    <el-radio disabled v-for="item in question.items" :key="item.prefix" :label="item.prefix">
                        <span v-html="item.content" class="q-item-span-content"></span>
                    </el-radio>
                </el-radio-group>
            ...
            <div v-else-if="qType == 4">
                ...
                <div v-if="answer.contentArray !== null">
                    ...
                    >
                        <el-input disabled v-model="answer.contentArray[item.prefix - 1]" />
                    </el-form-item>
                </div>
            </div>
